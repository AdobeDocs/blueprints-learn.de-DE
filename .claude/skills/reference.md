...
|------|---------|--------------------|
| **Übersicht/Hub** | Einführung in ein Produkt oder einen Bereich; Links zu Szenario-Blueprints | e.g. `overview.md`, `journey-optimizer-overview.md` |
...
| **Überlegungen zur Implementierung** | Wenn es wichtige Einschränkungen gibt | Unterabschnitte (z. B. Überlegungen zur Identität, attributbasierte Personalisierung). Aufzählungszeichen oder kurze Absätze; für Tiefe verknüpfen. |
