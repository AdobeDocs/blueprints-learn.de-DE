...
Dieses Projekt entspricht dem [Adobe Open Source-Verhaltenskodex](code-of-conduct.md) oder dem [.NET Foundation-Verhaltenskodex](https://dotnetfoundation.org/code-of-conduct). Weitere Informationen finden Sie im Artikel zum [Beisteuern von Inhalten](contributing.md).
