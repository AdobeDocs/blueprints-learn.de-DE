...
<img src="../assets/facebook.svg" alt="Referenzarchitektur für die Aktivierung von Facebook Custom Audiences" style="width:90%; border:1px solid #4a4a4a" class="modal-image" />
