...
<img src="assets/known_activation.png" alt="Referenzarchitektur für das Unternehmensaktivierungs-Szenario" style="width:90%; border:1px solid #4a4a4a" class="modal-image" />
