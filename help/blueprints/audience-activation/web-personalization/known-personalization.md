---
title: Übersicht über Web/Mobile-Personalisierung - Adobe Target und RTCDP
...
# Web-/Mobile-Personalisierung mit bekanntem Blueprint für Kundendaten
...
* Verwenden der [!DNL Edge Network] mit dem Web-/Mobile-SDK. Für die Edge-Echtzeit-Segmentierung ist das Implementierungsverfahren mit Web/Mobile SDKs oder der Edge-API erforderlich.
...
* [Siehe Abschnitt [!DNL Edge Network] Server-API](https://experienceleague.adobe.com/docs/experience-platform/edge-network-server-api/overview.html?lang=de) für eine API-basierte Implementierung von Adobe Target mit Edge Profile.
