...
* [Leitlinien für Profile und Segmentierung](https://experienceleague.adobe.com/en/docs/experience-platform/profile/guardrails)
...
* Konfigurieren Sie den [Marketo Engage-Quell-Connector](https://experienceleague.adobe.com/en/docs/experience-platform/sources/connectors/adobe-applications/marketo/marketo)
   * Verwenden Sie das oben definierte Datenwörterbuch, um die [Importzuordnung“ ](https://experienceleague.adobe.com/en/docs/experience-platform/data-prep/ui/mapping#import-mapping) Quell-Connectors zu definieren
...
* Definieren [Einkaufsgruppen](https://experienceleague.adobe.com/en/docs/journey-optimizer-b2b/user/accounts/buying-groups/buying-groups-overview) oder einer [Account-Journey](https://experienceleague.adobe.com/en/docs/journey-optimizer-b2b/user/account-journeys/journey-overview) mithilfe der Kontozielgruppe
