...
![Lösungsarchitektur für Journey Optimizer B2B edition mit Marketo-Daten](./assets/ajo-b2b-architecture-simplified.png){zoomable="yes"}
...
Diese Abfrage gibt die Anzahl der Personendatensätze zurück, die im Rahmen der Identitätszuordnung der Plattform zusammengeführt werden sollen.
...
* [Leitplanken für die Adobe Experience Platform-Bereitstellung](https://experienceleague.adobe.com/en/docs/blueprints-learn/architecture/architecture-overview/guardrails?lang=en)
