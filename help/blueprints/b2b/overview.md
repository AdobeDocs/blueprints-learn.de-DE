---
title: B2B Analytics und Activation
...
|---|---|---|
| **[B2B Analytics](b2bactivation.md)** | <ul><li>B2B-Kontoinformationen in die Journey-Analyse von Kunden einschließen</li></ul> | <ul><li>Adobe Customer Journey Analytics</li></ul> |
