...
Eine vollständige Liste der Anwendungsfälle zusammen mit der Dokumentation finden Sie [hier](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-usecases/cja-usecases.html?lang=de).
