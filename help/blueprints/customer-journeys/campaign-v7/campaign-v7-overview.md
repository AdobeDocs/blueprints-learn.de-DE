...
>[!IMPORTANT]
>
> Dieser Blueprint für Adobe Campaign v7 wird nicht mehr unterstützt. Die aktuelle Anleitung, Architektur und Best Practices finden Sie im Blueprint für Adobe Campaign v8.
> 
> 👉 Anzeigen der [Adobe [!DNL Campaign] v8-Blueprint](../campaign-v8/campaign-v8-overview.md))

<br>

## Architektur

<img src="images/campaign-v7-architecture.svg" alt="Referenzarchitektur für die Blueprint „Campaign v7“" style="width:100%; border:1px solid #4a4a4a" class="modal-image" />
