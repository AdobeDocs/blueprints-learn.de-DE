...
* Unterstützt nur Bereitstellungen von Adobe [!DNL Campaign] einzelnen Organisationseinheiten
* Adobe [!DNL Campaign] ist die wahre Quelle für alle aktiven Profile. Das bedeutet, dass Profile in Adobe [!DNL Campaign] vorhanden sein müssen und keine neuen Profile basierend auf Experience Platform-Segmenten erstellt werden sollten.
...
* Siehe RTCDP [!DNL Campaign]-Ziel-Connector - [RTCDP Campaign-Verbindung](https://experienceleague.adobe.com/docs/experience-platform/destinations/catalog/email-marketing/adobe-campaign-managed-services.html?lang=de)
...
1. Erstellen Sie Segmente für die Verwendung der Adobe-[!DNL Campaign].
...
>[!IMPORTANT]
>
>Es ist wichtig, zu diesem Zeitpunkt zu verstehen, welches Datenmodell sich in Experience Platform für Profil- und Ereignisdaten befindet, damit Sie wissen, welche Daten in Adobe [!DNL Campaign] erforderlich sind.
...
1. Senden Sie Adobe [!DNL Campaign]-Protokolle alle vier Stunden über Workflows zurück an Experience Platform (broadLog, trackingLog, Adressen, die nicht zustellbar sind).
...
* Vorgehensweise für Experience Platform Mobile SDK:
   * Nutzen Sie Adobe Tags und die [!DNL Campaign Classic]-Erweiterung, um Ihre Integration mit Experience Platform Mobile SDK einzurichten
...
>[!IMPORTANT]
>
>Wenn Sie die [!DNL Campaign] SDK bereitstellen und mit anderen Experience Cloud-Programmen arbeiten, ist für die Datenerfassung die Verwendung der Experience Platform Mobile SDK erforderlich. Dadurch werden duplizierte Client-seitige Aufrufe auf dem Gerät erstellt.
