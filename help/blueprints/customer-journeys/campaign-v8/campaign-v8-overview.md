---
title: Campaign v8 - Blueprint, Campaign und Plattform
...
Sie enthält außerdem einen skalierbaren Echtzeit-Messaging-Server, der Transaktionsnachrichten wie Kennwortzurücksetzungen, Bestellbestätigungen und E-Quittungen ermöglicht, indem vollständige Payloads von externen Systemen für die sofortige Bereitstellung akzeptiert werden.

## Anwendungsfälle

>[!BEGINTABS]

>[!TAB Batch-Kampagnenausführung]

- Entwerfen und Bereitstellen von groß angelegten, geplanten Marketing-Kampagnen für E-Mail, SMS und Briefpost.
- Ideal für Werbeangebote, Newsletter und saisonale Angebote mit komplexer Segmentierung und Zielgruppenbestimmung.

>[!TAB Multi-Touch-Orchestrierung]

- Erstellen Sie mehrstufige Multi-Channel-Programme, die Kunden durch eine vordefinierte Marketing-Journey führen.
- Unterstützt den erneuten Eintritt in Zielgruppen, bedingte Logik und zeitbasierte Transitionen.

>[!TAB Daten-Management und ETL]

- Aufnehmen, Transformieren und Verwalten von Kundendaten aus verschiedenen Quellen, um eine präzise Zielgruppenbestimmung zu unterstützen.
- Ermöglicht die Erstellung benutzerdefinierter Schemata, berechneter Felder und Zielgruppendefinitionen.

>[!TAB Transaktionsnachrichten]

- Senden Sie vordefinierte Nachrichten in Echtzeit, ausgelöst durch externe Systeme (z. B. Passwortrücksetzungen, Bestellbestätigungen, E-Quittungen).
- Verwendet einen skalierbaren Messaging-Server, der vollständige Payloads von IT-Systemen für die sofortige Bereitstellung akzeptiert.
