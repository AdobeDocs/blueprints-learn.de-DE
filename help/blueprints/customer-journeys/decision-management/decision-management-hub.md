...
# Entscheidungs-Management im Hub-Blueprint

Weitere Informationen zum Entscheidungs-Management finden Sie [HIER](https://experienceleague.adobe.com/docs/journey-optimizer/using/offer-decisioniong/get-started-decision/starting-offer-decisioning.html?lang=de) in der Produktdokumentation und [HIER](decision-management-overview.md) in der Übersicht über Entscheidungs-Management
...
>[!IMPORTANT]
>
>Für Anwendungsfälle von Angeboten und Journey, in denen auf das Profil zugegriffen werden muss, um zusätzliche Informationen und Kontext zu erhalten. Es ist wichtig, die damit verbundene Latenz bei der Aufnahme von Daten in ein Profil auf dem Hub zu berücksichtigen, um sicherzustellen, dass sie zum Zeitpunkt der Entscheidung verfügbar sind. Für Szenarien, in denen der Kontext in ein Profil gestreamt wird oder in das Profil aufgenommen wird und in denen das Angebot oder die Journey innerhalb von Sekunden oder Minuten nach der Angebotsentscheidung über diesen Kontext verfügen muss, eignen sich diese Szenarien am besten für das Entscheidungs-Management auf der Edge.

## Architektur

<img src="images/offers_hub.svg" alt="Referenzarchitektur zur Blueprint „Entscheidungs-Management im Edge“" style="width:100%; border:1px solid #4a4a4a" class="modal-image" />
...
[Leitplanken und Leitlinien für End-to-End-Latenzen](/help/blueprints/experience-platform/guardrails.md)
...
* Verwenden Sie für Edge-basierte Echtzeit-Erlebnisse die Web-/Mobile-SDK oder die Edge Decisioning-API, wie in der [Entscheidungs-Management im Edge-Blueprint“ beschrieben](decision-management-edge.md)
