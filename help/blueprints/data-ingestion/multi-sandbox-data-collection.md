...
description: Erfasste Daten streamen von [!DNL Experience Platform] (AEP) SDKs für mehrere Sandboxes mithilfe der Ereignisweiterleitung
...
# Entwurf der Datenerfassung für die Multi-Sandbox-Ereignisweiterleitung

Der Entwurf der Datenerfassung für die Ereignisweiterleitung für mehrere Sandboxes zeigt, wie Daten mit Adobe erfasst werden. [!DNL Experience Platform] Web- und Mobile-SDKs können so konfiguriert werden, dass sie ein einzelnes Ereignis erfassen und an mehrere [!DNL Experience Platform] (AEP)-Sandboxes. Diese Blueprint ist ein spezielles Anwendungsbeispiel, das die Ereignisweiterleitungsfunktion von Adobe Tags verwendet.
...
* [[!DNL Experience Platform] Web SDK - Übersicht](https://experienceleague.adobe.com/docs/experience-platform/edge/home.html?lang=de)
