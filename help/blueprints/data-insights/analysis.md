...
description: Adobe verwenden [!DNL Experience Platform] (AEM) zur Durchführung einer Sondierungsabfrage und -analyse der Daten, die im Data Lake vorhanden sind.
...
Datenanalyse und Datenintelligenz umfassen die Fähigkeit, [!DNL Experience Platform] zur Durchführung einer Sondierungsabfrage und -analyse der Daten, die im Data Lake vorhanden sind.

[!DNL Experience Platform]s [!UICONTROL Query Service] ermöglicht die Ausführung von SQL-Abfragen für die Daten.

[!DNL Experience Platform] ermöglicht Verbindungen mit SQL-Clients, Schnittstellen und Business Intelligence-Tools von Drittanbietern, direkt eine Verbindung zu den Daten herzustellen, darauf zuzugreifen und sie abzurufen innerhalb von [!DNL Experience Platform], wobei [!DNL PostgreSQL] Protokoll.
