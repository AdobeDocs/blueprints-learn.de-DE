...
description: Erfahren Sie, wie datenwissenschaftliche Erkenntnisse in [!DNL Experience Platform] integriert werden können, um das Echtzeit-Kundenprofil anzureichern.
...
Die benutzerdefinierte Datenwissenschaft für den Entwurf der Profilanreicherung zeigt, wie Daten zum Trainieren, Bereitstellen und Bewerten von Modellen verwendet werden können, um Einblicke in maschinelles Lernen in [!DNL Experience Platform] und die [!DNL Real-Time Customer Data Platform] aus Data Science und maschinellen Lernwerkzeugen zu erhalten.

Modellierte Einblicke können in [!DNL Experience Platform] erfasst werden, um das Echtzeit-Kundenprofil zu erweitern. Beispiele für ML-Erkenntnisse sind Lebenszeitwertbewertung, Produkt- und Kategorieaffinität, Konversions- oder Abwanderungsneigung.
...
* Detaillierte Limits und End-to-End-Latenzen bei der Aufnahme von Data Science-Ergebnissen in [!DNL Experience Platform] und das Echtzeit-Kundenprofil finden Sie in den Limits für die Datenerfassung und im Latenzdiagramm, auf das im Dokument [Bereitstellungsgarantien](../experience-platform/deployment/guardrails.md) verwiesen wird.
...
* Für das Extrahieren von Daten aus [!DNL Experience Platform] können die folgenden Methoden verwendet werden
   * Data Access SDK
...
* [Eine Einführung in die Explorationsdatenanalyse auf Adobe [!DNL Experience Platform]](https://medium.com/adobetech/an-introductory-look-at-exploratory-data-analysis-on-adobe-experience-platform-1bfce7501d9a)
