...
- In [!DNL Journey Optimizer] Entscheidung müssen stufenbasierte Eignungsregeln konfiguriert werden, um zu steuern, welche Eigentümer für exklusive Angebote, frühzeitigen Zugriff auf neue Fahrzeug-Enthüllungen und Partnerbelohnungen qualifiziert sind, um sicherzustellen, dass nur berechtigte Mitglieder jede Leistungskategorie erhalten.
- Die Angebotsschiedslogik muss ausstehende Nachrichten sowohl von Händlern als auch von OEM-Kanälen auswerten, bevor eine Nachricht gesendet wird. Dabei werden Werbeaktionen mit niedrigerer Priorität oder widersprüchlichen Werbeaktionen unterdrückt, um zu verhindern, dass derselbe Besitzer widersprüchliche Angebote gleichzeitig erhält.
- Die Cross-Channel-Koordination muss Händler-CRM-Systeme, digitale OEM-Eigenschaften, vernetzte Benachrichtigungskanäle für Autos und Service-Touchpoints umfassen, damit die Interaktionen mit den Kundinnen und Kunden unabhängig davon, wo der Eigentümer interagiert, einheitlich sind.
