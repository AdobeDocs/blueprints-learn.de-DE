...
| Reporting und Analyse | Eingeschlossen | Dieses Muster ist selbst ein Analysemuster. Diese Funktion ist inhärent enthalten, da der zentrale Ausführungsplan Reporting- und Analysefunktionen bietet. | [Übersicht über CJA](https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-overview/cja-overview) |
